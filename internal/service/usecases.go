...
type AuthUsersUseCase interface {
	CreateUser(params storage.CreateUserParams) (domain.User, error)
	AuthenticateUser(email, password string) (domain.User, error)
	AuthenticateOAuth(params storage.OAuthLoginParams) (domain.User, error)
	GetUser(id string) (domain.User, bool)
	ListUsers() []domain.User
	UpdateUser(id string, update storage.UserUpdate) (domain.User, error)
...
type ChannelsDirectoryUseCase interface {
	...
	UpdateChannel(id string, update storage.ChannelUpdate) (domain.Channel, error)
	...
	CreateSubscription(params storage.CreateSubscriptionParams) (domain.Subscription, error)
...
type UploadsUseCase interface {
	...
	CreateUpload(params storage.CreateUploadParams) (domain.Upload, error)
	UpdateUpload(id string, update storage.UploadUpdate) (domain.Upload, error)
}
...
type RecordingsVODUseCase interface {
	...
	CreateClipExport(recordingID string, params storage.ClipExportParams) (domain.ClipExport, error)
...
func NewStoreUseCases(store storage.Repository) *storeUseCases {
	return &storeUseCases{store: store}
}

func (s *storeUseCases) CreateUser(params storage.CreateUserParams) (domain.User, error) {
...
func (s *storeUseCases) AuthenticateOAuth(params storage.OAuthLoginParams) (domain.User, error) {
...
func (s *storeUseCases) UpdateUser(id string, update storage.UserUpdate) (domain.User, error) {
...
func (s *storeUseCases) UpdateChannel(id string, update storage.ChannelUpdate) (domain.Channel, error) {
...
func (s *storeUseCases) CreateSubscription(params storage.CreateSubscriptionParams) (domain.Subscription, error) {
...
func (s *storeUseCases) CreateUpload(params storage.CreateUploadParams) (domain.Upload, error) {
	return s.store.CreateUpload(params)
}
func (s *storeUseCases) UpdateUpload(id string, update storage.UploadUpdate) (domain.Upload, error) {
...
func (s *storeUseCases) CreateClipExport(recordingID string, params storage.ClipExportParams) (domain.ClipExport, error) {
