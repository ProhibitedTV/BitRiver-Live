...
func NewPaymentService(repo domain.PaymentsRepository, logger *slog.Logger) *PaymentService {
	if logger == nil {
		logger = slog.Default()
	}
...
func (s *PaymentService) CreatePendingTip(params domain.TipCreateParams) (domain.Tip, error) {
	if s == nil || s.repo == nil {
...
func (s *PaymentService) CreatePendingSubscription(params domain.SubscriptionCreateParams) (domain.Subscription, error) {
	if s == nil || s.repo == nil {
...
func (s *PaymentService) ProcessWebhook(provider string, params domain.ProcessPaymentWebhookParams) (domain.PaymentTransaction, error) {
	if s == nil || s.repo == nil {
