...
type Repository interface {
	...
	CreateAppeal(reportID, reporterID, reason string) (models.Appeal, error)
	ListAppeals(channelID, requesterID string, includeClosed bool) ([]models.Appeal, error)
	ResolveAppeal(appealID, resolverID, resolution string) (models.Appeal, error)
	ReopenAppeal(appealID, actorID, note string) (models.Appeal, error)
