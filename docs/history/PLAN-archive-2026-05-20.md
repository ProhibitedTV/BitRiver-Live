## Archived PLAN.md history

This file preserves the root `PLAN.md` scratchpad content that existed before issue #1229. It is historical context only; the active scoped plan lives in the repository root `PLAN.md`.
