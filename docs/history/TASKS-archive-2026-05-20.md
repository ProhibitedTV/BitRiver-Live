## Archived TASKS.md history

This file preserves the root `TASKS.md` scratchpad content that existed before issue #1229. It is historical context only; the active scoped task list lives in the repository root `TASKS.md`.
