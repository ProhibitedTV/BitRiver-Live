...
Run the latter with `./scripts/test-recovered-stack-golden-path.sh --release TAG --source-commit SHA --release-set-sha256 SHA256 --artifact-dir DIR` and retain its secret-scanned completion report.
