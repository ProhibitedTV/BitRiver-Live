...
- **Published artifact tag integrity:** Release bundle and Linux package tests
  ...
  defaults while preserving the canonical source env. RC13 independently
  passed this check and binds the public `.deb`, launcher, five image digests,
  and gate evidence to one signed release-set root.
