...
This definition proves deployment/process readiness. Production release approval additionally requires authenticated OME control, real RTMP ingest, public playback, and reboot/recovery evidence against the tagged artifact; a green unauthenticated OME root probe alone is not sufficient.
