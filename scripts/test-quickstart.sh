...
grep_healthcheck "ome" "healthcheck startup auth_mode="
grep_healthcheck "ome" "credential_type=access_token"
grep_healthcheck "ome" "credential_type=username_password"
grep_healthcheck "ome" "/v1/health"
