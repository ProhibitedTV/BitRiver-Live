...
- Next.js streaming and React transitions may briefly retain hidden fallback or settled content beside the visible settled view; Playwright assertions must target the visible settled relay state before requiring the transition copy to unmount.
